...
这是一个面向 BET 比表面积与孔结构数据处理的中文分析工具。项目当前以 Micromeritics TriStar II 3020 2.0 `SMP` 文件为起点，提供 SMP 解析、多样品对比、BET / Langmuir / t-Plot 拟合、图形化选区调整和 Excel 导出。
...
- 让 BET、Langmuir、t-Plot 等结果可以透明地查看、调整和比较。
...
- 吸附 / 脱附等温线多样品叠加显示。
- BET 拟合图、Langmuir 拟合图、t-Plot 图多样品叠加显示。
...
tristar_bet/analysis.py        BET、Langmuir、t-Plot 等分析计算
...
项目仍在持续开发中。当前重点是 TriStar II 3020 2.0 `SMP` 文件解析和 BET / Langmuir / t-Plot 的统一分析体验。
